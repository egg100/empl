...
public class RootController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		tcSmartPhone.setCellValueFactory(
			new Callback<CellDataFeatures<Phone,String>, ObservableValue<String>>() {
				@Override
		...
		TableColumn<Phone, String> tcImage = 
				(TableColumn<Phone, String>) tableView.getColumns().get(1);
		tcImage.setCellValueFactory(new PropertyValueFactory<Phone, String>("image"));
